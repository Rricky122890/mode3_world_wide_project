...
ActiveRecord::Schema.define(version: 2018_11_13_150507) do
  ...
  create_table "favorite_countries", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_favorite_countries_on_user_id"
  end
  ...
  add_foreign_key "favorite_countries", "users"
end
